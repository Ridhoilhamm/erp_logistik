...
class StockCreate extends Component
{
    ...
    public function loadStockHistory()
    {
        ...
        // Kita balik histori untuk hitung dari akhir ke awal
        $cards = $cards->reverse();
    ...
    public function save()
    {
        ...
        session()->flash('message', 'StockCard berhasil ditambahkan dan stok diperbarui.');
    }
    
    public function render()
    {
        return view('livewire.menu.stoks.stock-create')->title($this->title);
    }
}
